...
// Patch Vis Pods
<thaumadditions:vis_pod>.withTag({Aspect: "aer"}).setAspects(<aspect:aer>);
<thaumadditions:vis_pod>.withTag({Aspect: "terra"}).setAspects(<aspect:terra>);
<thaumadditions:vis_pod>.withTag({Aspect: "ignis"}).setAspects(<aspect:ignis>);
<thaumadditions:vis_pod>.withTag({Aspect: "aqua"}).setAspects(<aspect:aqua>);
<thaumadditions:vis_pod>.withTag({Aspect: "ordo"}).setAspects(<aspect:ordo>);
<thaumadditions:vis_pod>.withTag({Aspect: "perditio"}).setAspects(<aspect:perditio>);
<thaumadditions:vis_pod>.withTag({Aspect: "vacuos"}).setAspects(<aspect:vacuos>);
<thaumadditions:vis_pod>.withTag({Aspect: "lux"}).setAspects(<aspect:lux>);
<thaumadditions:vis_pod>.withTag({Aspect: "motus"}).setAspects(<aspect:motus>);
<thaumadditions:vis_pod>.withTag({Aspect: "gelum"}).setAspects(<aspect:gelum>);
<thaumadditions:vis_pod>.withTag({Aspect: "vitreus"}).setAspects(<aspect:vitreus>);
<thaumadditions:vis_pod>.withTag({Aspect: "metallum"}).setAspects(<aspect:metallum>);
<thaumadditions:vis_pod>.withTag({Aspect: "victus"}).setAspects(<aspect:victus>);
<thaumadditions:vis_pod>.withTag({Aspect: "mortuus"}).setAspects(<aspect:mortuus>);
<thaumadditions:vis_pod>.withTag({Aspect: "potentia"}).setAspects(<aspect:potentia>);
<thaumadditions:vis_pod>.withTag({Aspect: "permutatio"}).setAspects(<aspect:permutatio>);
<thaumadditions:vis_pod>.withTag({Aspect: "praecantatio"}).setAspects(<aspect:praecantatio>);
<thaumadditions:vis_pod>.withTag({Aspect: "auram"}).setAspects(<aspect:auram>);
<thaumadditions:vis_pod>.withTag({Aspect: "alkimia"}).setAspects(<aspect:alkimia>);
<thaumadditions:vis_pod>.withTag({Aspect: "vitium"}).setAspects(<aspect:vitium>);
<thaumadditions:vis_pod>.withTag({Aspect: "tenebrae"}).setAspects(<aspect:tenebrae>);
<thaumadditions:vis_pod>.withTag({Aspect: "alienis"}).setAspects(<aspect:alienis>);
<thaumadditions:vis_pod>.withTag({Aspect: "volatus"}).setAspects(<aspect:volatus>);
<thaumadditions:vis_pod>.withTag({Aspect: "herba"}).setAspects(<aspect:herba>);
<thaumadditions:vis_pod>.withTag({Aspect: "instrumentum"}).setAspects(<aspect:instrumentum>);
<thaumadditions:vis_pod>.withTag({Aspect: "fabrico"}).setAspects(<aspect:fabrico>);
<thaumadditions:vis_pod>.withTag({Aspect: "machina"}).setAspects(<aspect:machina>);
<thaumadditions:vis_pod>.withTag({Aspect: "vinculum"}).setAspects(<aspect:vinculum>);
<thaumadditions:vis_pod>.withTag({Aspect: "spiritus"}).setAspects(<aspect:spiritus>);
<thaumadditions:vis_pod>.withTag({Aspect: "cognitio"}).setAspects(<aspect:cognitio>);
<thaumadditions:vis_pod>.withTag({Aspect: "sensus"}).setAspects(<aspect:sensus>);
<thaumadditions:vis_pod>.withTag({Aspect: "aversio"}).setAspects(<aspect:aversio>);
<thaumadditions:vis_pod>.withTag({Aspect: "praemunio"}).setAspects(<aspect:praemunio>);
<thaumadditions:vis_pod>.withTag({Aspect: "desiderium"}).setAspects(<aspect:desiderium>);
<thaumadditions:vis_pod>.withTag({Aspect: "exanimis"}).setAspects(<aspect:exanimis>);
<thaumadditions:vis_pod>.withTag({Aspect: "bestia"}).setAspects(<aspect:bestia>);
<thaumadditions:vis_pod>.withTag({Aspect: "humanus"}).setAspects(<aspect:humanus>);
<thaumadditions:vis_pod>.withTag({Aspect: "fluctus"}).setAspects(<aspect:fluctus>);
<thaumadditions:vis_pod>.withTag({Aspect: "sonus"}).setAspects(<aspect:sonus>);
<thaumadditions:vis_pod>.withTag({Aspect: "exitium"}).setAspects(<aspect:exitium>);
<thaumadditions:vis_pod>.withTag({Aspect: "caeles"}).setAspects(<aspect:caeles>);
<thaumadditions:vis_pod>.withTag({Aspect: "draco"}).setAspects(<aspect:draco>);
<thaumadditions:vis_pod>.withTag({Aspect: "infernum"}).setAspects(<aspect:infernum>);
<thaumadditions:vis_pod>.withTag({Aspect: "ventus"}).setAspects(<aspect:ventus>);
<thaumadditions:vis_pod>.withTag({Aspect: "visum"}).setAspects(<aspect:visum>);
<thaumadditions:vis_pod>.withTag({Aspect: "imperium"}).setAspects(<aspect:imperium>);
